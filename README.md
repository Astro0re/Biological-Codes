...
[Code(Python)](DNA_Sequence.py) or [Code(R)](DNA_Sequence.r)
...
AI classification model for Red blood cells, to be used for anaomaly scan to identify diseases affecting the oxygen carrying cell that is erythrocytes; [Code(Python)](Genotype%20Identification.py) [Code_2(JupyterNotebook)](Genotype_Identifier.ipynb)
